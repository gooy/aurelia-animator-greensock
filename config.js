System.config({
  ...
  "bundles": {
    ...
    "app-bundle": [
      "config",
      "github:greensock/GreenSock-JS@1.17.0/TweenMax",
      "github:daepark/JSOL@master/jsol",
      "github:greensock/GreenSock-JS@1.17.0",
      "github:daepark/JSOL@master",
      "github:gooy/aurelia-animator-greensock@0.0.1/animator",
      "github:gooy/aurelia-animator-greensock@0.0.1/index",
      "github:gooy/aurelia-animator-greensock@0.0.1",
      "settings",
      "nav-bar",
...
System.config({
  "map": {
    ...
    "gooy/aurelia-animator-greensock": "github:gooy/aurelia-animator-greensock@0.0.1",
